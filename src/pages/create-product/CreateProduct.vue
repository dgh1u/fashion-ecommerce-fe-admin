<template>
  <div class="create-product max-w-3xl mx-auto space-y-4">
    ...
    <div class="block bg-white p-4 pb-6 rounded-xl">
      ...
      <label>Loại quần áo <span class="text-red-500">*</span> </label>
      <div class="flex rounded-lg mt-1">
        <a-select
          ...
          class="w-full"
        >
          <a-select-option value="Áo thun">Áo thun</a-select-option>
          <a-select-option value="Áo sơ mi">Áo sơ mi</a-select-option>
          <a-select-option value="Áo kiểu">Áo kiểu</a-select-option>
          <a-select-option value="Áo khoác">Áo khoác</a-select-option>
          <a-select-option value="Quần dài">Quần dài</a-select-option>
          <a-select-option value="Quần ngắn">Quần ngắn</a-select-option>
          <a-select-option value="Váy">Váy</a-select-option>
          <a-select-option value="Đồ lót">Đồ lót</a-select-option>
          <a-select-option value="Đồ mặc nhà">Đồ mặc nhà</a-select-option>
        </a-select>
      </div>
    ...
    >
      ...
      <div class="grid grid-cols-2 gap-y-3">
        <div
          ...
          :class="{ 'text-sky-500': formData.criteria[feature.value] }"
        ...
        >
          <div class="relative">
            ...
            <div
              ...
              :class="{
                'bg-sky-500 border-sky-500': formData.criteria[feature.value],
              }"
            >
              <CheckIcon
    ...
    <div
      v-if="formData.criteria.firstClass === 'QUAN_AO'"
      class="block bg-white p-4 rounded-xl"
    >
      <SizeInventoryForm
